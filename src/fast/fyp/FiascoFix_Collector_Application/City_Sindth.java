...
public class City_Sindth extends Activity {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parentAdapter, View view,
				...
				if (clickedView.getText() == "Attock") {
					...
					Toast.makeText(City_Sindth.this, "ali jljlj", Toast.LENGTH_SHORT)
							.show();
					Intent i = new Intent();

					i.setClass(City_Sindth.this, Zone.class);
					startActivity(i);
				}
				//
				// Toast.makeText(
	...
	private void initList() {
		...
		planetsList.add(createPlanet("planet", "Badin"));

		planetsList.add(createPlanet("planet", "Bhirkan"));
